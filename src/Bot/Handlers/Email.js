const {Emails} = require('../Data/CallDatabase.js');
...
module.exports = class Email {
    static async create(userID, emailName) {
        ...
        return {result: 'success', message: `You have created an e-mail! Your e-mail is \`${emailName}@project-memory.net\``};
    }
    ...
    static async block(id, emailName) {
        ...
        return {result: 'success', message: `Blocked \`${emailName}@project-memory.net\` successfully.`};
    }
    ...
    static async unblock(id, emailName) {
        ...
        return {result: 'success', message: `Unblocked \`${emailName}@project-memory.net\` successfully.`};
    }
